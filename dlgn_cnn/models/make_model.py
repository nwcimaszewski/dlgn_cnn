...
def make_video_model(
    ...
    if readout_type == "gaussian":
        grid_mean_predictor, grid_mean_predictor_type, source_grids = prepare_grid(
            readout_dict["grid_mean_predictor"], dataloaders, from_deeplake
        )
        ...
        readout = MultipleFullGaussian2d(**readout_dict) # Here is where the readout is actually constructed.  
    ...
    # HARD CODE...make this more general
